...
class Miner(BaseMinerNeuron):
    ...
    def __init__(self, config=None):
        ...
        self.model_manifest = build_local_model_manifest(
            ...
            implementation_files=[
                repo_root / "weights" / "gen13_tens28_4_0_25_0_ft5_long_hardened.ts",
            ...
            defaults={
                "model_name": "poker44_ml13tens28",
                "model_version": "13.28",
                "framework": "pytorch-torchscript",
                "license": "MIT",
                "repo_url": "https://github.com/tomkaba/poker44-miner-ml13tens28",
                "repo_commit": git_commit,
                "notes": "Gen13Tens28 neural network scorer (AAF=4, RWRT=25, ft5 long)",
                "open_source": True,
    ...
    async def forward(self, synapse: DetectionSynapse) -> DetectionSynapse:
        ...
        bt.logging.info(f"Scored {len(chunks)} chunks with scorer ml13tens28.")
        return synapse
...
if __name__ == "__main__":
    ...
    with Miner() as miner:
        ...
        while True:
            bt.logging.info(
                f"Miner UID: {miner.uid} | Incentive: {float(miner.metagraph.I[miner.uid])} | Scorer: ml13tens28"
            )
            time.sleep(60)
